...
public class DesktopPane extends FlowPane {
    ...
    public DesktopPane() {
        this.getStyleClass().add("qxt-pane");
...
//        initPopupMenu();
    ...
    private void initPopupMenu() {
        ...
        contextMenu.getStyleClass().add("qxt-context-menu");

        fullScreen.setOnAction(e->{
            if (PrimaryStage.STAGE != null) {
                PrimaryStage.STAGE.setFullScreen(true);
            }
        });
        notFullScreen.setOnAction(e->{
            if (PrimaryStage.STAGE != null) {
                PrimaryStage.STAGE.setFullScreen(false);
            }
        });
