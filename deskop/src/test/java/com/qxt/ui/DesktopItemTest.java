...
import com.qxt.util.ThreadToolUtil;
...
//        DesktopToolbar toolbar = new DesktopToolbar();
        ...
        desktop.getStyleClass().add("qxt");
//        qxt.setPadding(new Insets(20));
//        qxt.getChildren().addNewStage(new DesktopItem(image, "Win10-UI官网", "http://www.baidu.com"));
//        qxt.getChildren().addNewStage(new DesktopItem(image, "Win10-UI官网", "http://www.baidu.com"));
//        qxt.getChildren().addNewStage(new DesktopItem(image, "Win10-UI官网", "http://www.baidu.com"));
//        qxt.getChildren().addNewStage(new DesktopItem(image, "Win10-UI官网", "http://www.baidu.com"));
//        qxt.getChildren().addNewStage(new DesktopItem(image, "Win10-UI官网", "http://www.baidu.com"));
