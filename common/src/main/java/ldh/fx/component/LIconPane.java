...
public class LIconPane extends BorderPane {
        ...
        for (Class clazz : glyphIconClasses) {
            if (clazz.isEnum()) {
                ...
                fontawareBtn.setOnAction(e->{
                    ...
                    currentIconNode.showData(true);
                    currentClass = fontawareBtn.getText();
                    IconNode iconNode = glyphIconNodeMap.get(currentClass);
                    iconNode.showData(true);
    ...
    private void translate(IconNode currentIconNode, IconNode iconNode) {
        ...
        contentPane.widthProperty().addListener((b, o, n)->{
            iconNode.setPrefSize(contentPane.getPrefWidth(), contentPane.getPrefHeight());
        });
    ...
    private class IconNode extends ScrollPane {
        ...
        private TilePane flowPane = new TilePane();
        ...
        public IconNode(Class glyphIconClass, boolean isShowing) {
            ...
            flowPane.setPrefTileWidth(80);
            flowPane.setPrefTileHeight(80);
            ...
            new Thread(new Task<Void>() {
                ...
                protected Void call() throws Exception {
                    initUi();
                    System.out.println("initUI end: " + glyphIconClass);
                    return null;
                }
            }).start();
        }

        public void showData(boolean isShowing) {
...
//            if (isShowing) {
//                Platform.runLater(()->this.showData(isShowing));
//            }
            Platform.runLater(()->this.showData(isShowing));
        }
