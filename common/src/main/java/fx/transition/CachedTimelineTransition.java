...
public class CachedTimelineTransition extends Transition {
     ...
     */
    public CachedTimelineTransition(final Region node, final Timeline timeline) {
     ...
     */
    public CachedTimelineTransition(final Region node, final Timeline timeline, final boolean useCache) {
        this.node = node;
