...
public class UndecoratorSceneDemo extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        ...
        // Overrides defaults
        undecoratorScene.addStylesheet("/css/demoapp.css");
...
//        undecoratorScene.setAsStageDraggable(stage, node);
        ...
        // Application icons
        Image image = new Image("/img/in-sidefx.png");
    ...
    private void handleShowUtilityStage(ActionEvent event) throws IOException {
        // Stage Utility usage
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/ClientAreaUtility.fxml"));
        fxmlLoader.setController(this);
        Region root = (Region) fxmlLoader.load();
        ...
        // Overrides defaults
        scene.addStylesheet("/css/demoapp.css");
