 ...
 *
 * {@literal @}keyframes bounceInLeft { 0% { opacity: 0; -webkit-transform: translateX(-2000px);
 * } 60% { opacity: 1; -webkit-transform: translateX(30px); } 80% { -webkit-transform:
 * translateX(-10px); } 100% { -webkit-transform: translateX(0); } }
 *
 * @author Jasper Potts
 */
public class BounceInLeftTransition extends CachedTimelineTransition {
     ...
     */
    public BounceInLeftTransition(final Region node) {
        super(node, null);
