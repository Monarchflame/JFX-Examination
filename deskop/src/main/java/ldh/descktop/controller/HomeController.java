    ...
    @FXML public void leftNaveClick(ActionEvent e) {
        ...
        if (parent instanceof Button) {
            ...
            if (userData.toString().equals("chart1")) {
                changeContent(new ScrollPane(new ChartContent()));
            } else if (userData.toString().equals("form1")) {
                changeContent(new ScrollPane(new FormContent()));
...
//        root.widthProperty().addListener((ob, o, n) -> {
//            contentPane.setMinWidth(n.doubleValue()-leftPane.getPrefWidth());
//            contentPane.setPrefWidth(n.doubleValue()-leftPane.getPrefWidth());
//            contentPane.setMaxWidth(n.doubleValue()-leftPane.getPrefWidth());
//        });
...
//            contentPane.setPrefWidth(contentScrollPane.getScene().getWidth()-leftPane.getWidth());
        });
